...
def phoneControl():
    ...
    while True:
        ...
        #print(release_hold_frame_counter)
        click = False
        try:
            ...
            elif(first_element[0] != -1 and finger_down_bool == True):
                if(click != True):
                    finger_move_location = first_element

                    #time.sleep(0.2)

            elif(finger_up_location[0] != -1 and finger_down_bool == True):
                #print("down prev is , up location is ",finger_down_location_prev[0], finger_up_location[0])

                if(reduceThresholdofPoints(finger_up_location,finger_down_location_prev, 200) != -2 and finger_move_location[0] != -1):

                    d.swipe_points([(finger_down_location_prev[0], finger_down_location_prev[1]), (finger_move_location[0], finger_move_location[1]), (finger_up_location[0], finger_up_location[1] + 10)], 0.05)
                    ...
                    click_delay = 0
                    #print("Release hold frame coutner", release_hold_frame_counter)
                    if(release_hold_frame_counter < 30 and release_hold_frame_counter > 0):

                        d.click(finger_up_location[0], addOffset(finger_up_location[1], 10))
                        finger_down_bool = False
